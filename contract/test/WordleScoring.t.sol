...
contract WordleScoringHarness {
    function score(string memory answer, string memory guess) external pure returns (uint8[5] memory) {
...
contract WordleScoringTest is Test {
    ...
    function testAllWrongLetters() public view {
    ...
    function testAllCorrectLetters() public view {
    ...
    function testAnswerDuplicateLetters() public view {
    ...
    function testGuessDuplicateLetters() public view {
    ...
    function testExactMatchConsumesBeforeMisplacedMatch() public view {
    ...
    function assertStatuses(uint8[5] memory statuses, uint8[5] memory expectedStatuses) internal pure {
